...
<h2 id="asyncfn">AsyncFn</h2>

Note, we don't pass the generic type to AsyncCtx because it causes TypeScript to not infer the type of the resource correctly. The type is only used for the `previous` property, which is not commonly used, and can be easily cast if needed.
...
<h2 id="computedoptions">ComputedOptions</h2>
...
<h2 id="computedreturntype">ComputedReturnType</h2>
...
<h2 id="computedsignal-force">force</h2>
...
**References:** [DevJSX](#devjsx), [ValueOrPromise](#valueorpromise), [JSXOutput](#jsxoutput)
...
(qrl: [QRL](#qrl-type-alias)&lt;FIRST&gt;, ...rest: REST) =&gt; RET
...
**References:** [ValueOrPromise](#valueorpromise), [JSXOutput](#jsxoutput)
...
<h2 id="qwikresumeevent">QwikResumeEvent</h2>
...
<h2 id="qwikviewtransitionevent">QwikViewTransitionEvent</h2>
...
<h2 id="revealorder">RevealOrder</h2>
...
<h2 id="revealprops">RevealProps</h2>
...
<h2 id="ssrstreamchildren">SSRStreamChildren</h2>
...
<h2 id="ssrstreamwriter">SSRStreamWriter</h2>
...
(callback: () =&gt; [ValueOrPromise](#valueorpromise)&lt;void&gt;) =&gt; void
...
<h2 id="ssrstreamwriter-write">write</h2>
